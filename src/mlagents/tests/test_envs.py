...
from src.mlagents.base_env import BatchedStepResult
from src.mlagents.exception import UnityEnvironmentException, UnityActionException
from src.mlagents.mock_communicator import MockCommunicator


@mock.patch("src.mlagents.environment.UnityEnvironment.get_communicator")
def test_handles_bad_filename(get_communicator):
    with pytest.raises(UnityEnvironmentException):
        UnityEnvironment(" ")


@mock.patch("src.mlagents.environment.UnityEnvironment.executable_launcher")
@mock.patch("src.mlagents.environment.UnityEnvironment.get_communicator")
