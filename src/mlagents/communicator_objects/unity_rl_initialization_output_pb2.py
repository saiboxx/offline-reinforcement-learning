...
from src.mlagents.communicator_objects import brain_parameters_pb2 as mlagents_dot_envs_dot_communicator__objects_dot_brain__parameters__pb2
...
UnityRLInitializationOutputProto = _reflection.GeneratedProtocolMessageType('UnityRLInitializationOutputProto', (_message.Message,), dict(
  ...
  __module__ = 'src.mlagents.communicator_objects.unity_rl_initialization_output_pb2'
